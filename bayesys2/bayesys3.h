...
// BayeSys3 external 
  ...
  int       Valency;    // I   0, or basesys valency

// basesys external (referenced by BayeSys3 and used if Valency > 0)
  int       basesys;    // I   Method of analysing Gaussian or Poisson data
...
// basesys internal (referenced by BayeSys3 and used if Poisson data)
...
// basesys external (referenced by BayeSys3 and used there iff Valency > 0)
...
// basesys internal (referenced by BayeSys3 and used there if Valency > 0)
  int       reset;          // Reset inserted basesys fluxes?
...
extern int UserDelete1(    //   O  >=0 is OK, -ve is error abort
      ...
      ObjectStr* Object);  // I O  Sample object
                           ...
                           // Mock data from unit flux for basesys
...
#undef  E_BASESYS_PARMS
#define E_BASESYS_PARMS   -210  // Wrong input parameters
#undef  E_BASESYS_OVERLAP
#define E_BASESYS_OVERLAP -211  // Valency footprints overlap wrongly
#undef  E_BASESYS_NBITS
#define E_BASESYS_NBITS   -212  // Too many fragments
#undef  E_BASESYS_RANGE
#define E_BASESYS_RANGE   -213  // Fragment outside data range
#undef  E_BASESYS_DATA
#define E_BASESYS_DATA    -214  // Negative count data supplied
#undef  E_BASESYS_COUNTS
#define E_BASESYS_COUNTS  -215  // Count data too large threatening overflow
#undef  E_MALLOC
